...
<section class="page-hero">
  <div class="container">
    <div class="breadcrumb"><a href="index.html">ホーム</a> / <a href="recruiting.html">事業内容</a> / 人事制度・組織開発</div>
...
<section>
  <div class="container">
    <div class="section-head reveal">
      <span class="eyebrow">From Onboarding to Retention</span>
      <h2>制度と仕組みで、採用から定着をつなげる</h2>
      <p>採用時点の期待値と、入社後の評価・キャリアパスがずれていると、早期離職の原因になります。等級・評価・処遇の仕組みを整えることで、「採用した人がそのまま育ち、活躍し続ける」状態を制度の側からつくります。ヒトイクは採用コンサルティングと制度設計を一体で支援できるため、入口から定着までを一気通貫でご提案できます。</p>
      <a href="recruiting.html" class="more">採用コンサルティングを見る {icon('arrow-right')}</a>
    </div>
  </div>
</section>
