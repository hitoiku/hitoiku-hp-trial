...
<section class="page-hero">
  <div class="container">
    <div class="breadcrumb"><a href="index.html">ホーム</a> / 代表紹介</div>
    <span class="eyebrow">Message</span>
    <h1>代表紹介</h1>
    <p class="lead">UPDATE HUMAN という理念のもとに。</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="profile-hero reveal">
      <div>
        ...
        <p class="credential-line">現場歴18年 ／ CHRO ／ MBA（在学中） ／ 公認心理師 ／ 社会福祉士</p>
      </div>
      <div>
...
<section class="pain-band">
  <div class="container">
    ...
    <div class="timeline reveal">
      <div class="timeline-item"><div class="yr">2008年</div><p>愛知県内の工業高校を卒業後、株式会社アイシンの人材育成部門へ入社。企業内訓練校で将来の幹部候補生として必要な資質を磨く。</p></div>
      <div class="timeline-item"><div class="yr">2009年</div><p>株式会社アイシンにて、指導者・管理監督者としてチームを牽引。</p></div>
      <div class="timeline-item"><div class="yr">2016年</div><p>海外へ渡り、現地拠点の自立化支援を担当。帰国後は働きながら大学で心理学を学び、人の成長や行動変容の理論を体系的に習得。</p></div>
      <div class="timeline-item"><div class="yr">2023年</div><p>人事部 企画グループへ異動し、全社の育成・組織づくりに関わる企画を推進。</p></div>
      <div class="timeline-item"><div class="yr">2024年</div><p>"ヒトの育成をする会社 Hitoiku" を設立。同年、株式会社ナーシングの取締役CHROに就任し、現場と経営の両面から組織づくりに携わる。</p></div>
      <div class="timeline-item"><div class="yr">2026年〜</div><p>経営大学院（MBA）へ入学。</p></div>
    </div>

    <div class="reveal" style="margin-top:56px; max-width:760px;">
      <p>資格は公認心理師と社会福祉士を持っており、2018年には文部科学大臣賞をいただきました。現在はHitoiku CEOとして、また株式会社ナーシングの取締役CHROとして、現場と経営の両方に軸足を置きながら組織づくりに携わっています。休みの日はフルマラソンやゴルフ、旅行で心身をリセットするのが好きです。</p>
    </div>
  </div>
</section>
...
<section>
  <div class="container">
    <div class="cta-band reveal">
      <div>
        <h2>貴社の成長を、共に実現しませんか。</h2>
        <p>まずはお気軽にご相談ください。最適なソリューションをご提案いたします。</p>
      </div>
      <div class="actions">
        <a href="contact.html" class="btn btn-ghost-light">Contact {icon('arrow-right')}</a>
        <a href="recruiting.html" class="btn btn-outline" style="border-color:rgba(255,255,255,.5);color:#fff;">事業内容を見る</a>
      </div>
    </div>
  </div>
</section>
